...
<div align="center">
    <br>
  <h1 style="font-size: 35px; color: lightblue"><b>Catalog Group Project</b></h1>
</div>
...
# 📖 Catalog Ruby Project <a id="about-project"></a>

**Catalog Project** is a console app that will help you to keep a record of different types of things you own: books, music albums, movies, and games.
...
```sh
  git clone https://github.com/kwesiObuobi/catalog-group-project.git
```
